    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            ZStack{
                ...
                .overlay(
                    PerspectiveView(content:ModifyView(isCom: $isCom, isShowingModify: $isShowingModify, backgroundIndex: $backgroundIndex, chessIndex: $chessIndex, p1Color: $p1Color, p2Color: $p2Color)
